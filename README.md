...
1. The code assumes that your time information is in gps time (nanoseconds).
2. The code assumes that your data columns will have numerical information, if there are non-numerical strings other than the title, it will crash.
